    ...
    if zanshin_token and zanshin_url and zanshin_organization_id:
        try:
            ...
            if response.status_code == 200:
                ...
                selected_history_fields, selected_snapshot_fields = process_response(response.json(), project_name, tool_type, tool_name, zanshin_url, zanshin_token, existing_ids)
                try:
